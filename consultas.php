...
$pdf->Cell(190, 6, "Fecha: " . $fecha_actual, 0, 1, 'C');
$pdf->Cell(190, 6, "Generado por: " . $usuario, 0, 1, 'C');
$pdf->Ln(10);

// Borde y encabezados
$pdf->SetFillColor(28, 117, 188); // Azul del logo
$pdf->SetTextColor(255, 255, 255); // Texto blanco en el título
$pdf->Cell(190, 10, "Detalles del Informe", 1, 1, 'C', true);
$pdf->SetTextColor(0, 0, 0); // Texto negro nuevamente
...
if (!empty($data) && !isset($data['mensaje'])) {
    ...
    foreach ($data as $row) {
        $pdf->Cell(190, 8, implode(" | ", $row), 1, 1, 'C', true);
    }
} else {
...
$pdf->Cell(190, 10, "Contacto: +57 310 123 4567 | Correo: info@suramericanaguantes.com", 0, 1, 'C');
$pdf->Cell(190, 10, "Dirección: Palmira, Valle del Cauca, Colombia", 0, 1, 'C');
